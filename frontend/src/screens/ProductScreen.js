...
const ProductScreen = ({ history, match }) => {
  ...
  const arr = product.description?.split('//');
          ...
          <Row>
            ...
            <Col md={3}>
              <ListGroup variant='flush'>
                ...
                <ListGroup.Item>
                  <div style={{ marginBottom: 10 }}>Color: {arr?.length > 3 && arr[1]}</div>
                  <div style={{ marginBottom: 10 }}>Ram: {arr?.length > 3 && arr[2]}</div>
                  <div style={{ marginBottom: 10 }}>Storage: {arr?.length > 3 && arr[3]}</div>
                  <div>Description: {arr?.length > 3 && arr[0]}</div>
                </ListGroup.Item>
                <ListGroup.Item />
              </ListGroup>
            </Col>
